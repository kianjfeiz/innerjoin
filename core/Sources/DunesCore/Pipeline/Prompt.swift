...
enum Prompt {
    ...
    ///
    /// This is the whole of dunes's "training": no weights change, but each
    ...
    /// providers; the two things dunes queries on, `amount` and dates, are typed.
    ...
    struct Jobs {
        ...
        static var fromEnvironment: Jobs {
            ...
            return Jobs(problems: environment["DUNES_NO_PROBLEMS"] == nil,
                        assertions: environment["DUNES_NO_ASSERTIONS"] == nil)
        }
    }
