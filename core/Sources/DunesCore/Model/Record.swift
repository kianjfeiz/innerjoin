...
/// round-trips exactly across every model provider. The two things dunes
...
/// What dunes understood from a document. One document, one record.
...
public struct RecordDate: Codable, Identifiable, Equatable, Sendable {
    ...
    /// True when dunes computed it rather than reading it — a notice deadline
